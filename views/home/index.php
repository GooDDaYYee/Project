            ...
            <div class="col-md-12">
                <div class="card border h-100">
                    <table width="100%" class="table-striped">
                        <thead>
                            <tr>
                                <th style="padding-top: 10px;" width="20%" scope="col"><h5>ผู้แชร์</h5></th>
                                <th style="padding-top: 10px;" width="30%" scope="col"><h5>เอกสาร</h5></th>
                                <th style="padding-top: 10px;" width="20%" scope="col"><h5>วันที่</h5></th>
                                <th style="padding-top: 10px;" width="30%" scope="col"><h5>รายละเอียด</h5></th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php if (count($data['shared_files']) > 0): ?>
                                <?php foreach ($data['shared_files'] as $row): 
                                ...
                                ?>
                                    <tr class='file-item' data-id="<?php echo $row['files_id'] ?>" data-name="<?php echo $name ?>">
                                        ...
                                        <td><i class="to_file"><?php echo $this->formatDate($row['files_date']); ?></i></td>

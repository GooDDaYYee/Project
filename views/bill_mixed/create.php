<div class="container-fluid">
    <div class="card shadow mb-4">
        <div class="card-header d-flex justify-content-between align-items-center py-3">
            <div>
                <i class="fa fa-plus-circle" aria-hidden="true"></i>&nbsp;เพิ่มเอกสารใบเสนอราคา/ใบแจ้งหนี้/ใบเสร็จรับเงิน บริษัท Mixed
            </div>
        </div>
        <div class="card-body">
                    ...
                    <div class="col-lg">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h2 text-gray-900 mb-4">เพิ่มเอกสารใบเสนอราคา/ใบแจ้งหนี้/ใบเสร็จรับเงิน บริษัท Mixed</h1>
                            </div>
                            <hr>
...
<script>
    $(document).ready(function() {
        ...
        $('#mixedBillForm').submit(function(e) {
            e.preventDefault();
            ...
            $.ajax({
                type: "POST",
                url: "index.php?page=bill-mixed&action=create",
                data: $(this).serialize(),
                dataType: 'json',
                success: function(response) {
                    if (response.success) {
                        Swal.fire({
                            ...
                            window.location.href = "index.php?page=bill-mixed";
                        });
                    } else {
                        Swal.fire({
                            icon: 'error',

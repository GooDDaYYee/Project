   ...
   <div id="content-wrapper" class="d-flex flex-column">
     ...
     <div id="content">
       ...
       <!-- End of Topbar -->
       <?php
        if (!isset($_POST['browser'])) { // ตรวจสอบว่ามีการส่งข้อมูลจากฟอร์มหรือไม่
        ?>
                     ...
                     <script>
                                  ...
                                  <div>
                                      ...
                                      if ($rowcount > 0) {
                                        while ($rs = mysqli_fetch_array($result)) {
                                          ...
                                          if ($rs['au_id'] == $_POST['browser']) { // นำเคอเซอร์ข้อมูลกลับไปที่แถวแรก
                       ...
                       document.addEventListener("DOMContentLoaded", function() {
                         document.getElementById('browser').addEventListener('input', function() {
                           ...
                           console.log('Selected Value: ' + selectedValue); // สำหรับตรวจสอบใน Console ของเบราว์เซอร์
                         });
                       });
                     </script>
